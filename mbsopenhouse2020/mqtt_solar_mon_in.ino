...
#define MAX485_DE  2        // D4  //DE                       
#define MAX485_RE  14       //D5  //RE
...
WiFiClient nodeSolarMonin;
PubSubClient client(nodeSolarMonin);
...
Serial.begin(9600);                                     
PZEMSerial.begin(9600,SWSERIAL_8N2,12,13);    //D6=RO,D7=DI
