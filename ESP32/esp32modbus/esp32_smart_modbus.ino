...
void setup() {
 ...
 //delay(3000);
  ...
  relayControl_modbusRTU(4,1,0);  //Address, channel, logic 0=off,1=on , Valve1
  relayControl_modbusRTU(4,2,0);  //Address, channel, logic 0=off,1=on , Valve2
  relayControl_modbusRTU(4,3,0);  //Address, channel, logic 0=off,1=on , Valve3
  relayControl_modbusRTU(4,4,0);  //Address, channel, logic 0=off,1=on , Valve4
  
  relayControl_modbusRTU(5,1,0);  //Address, channel, logic 0=off,1=on , Valve5
  relayControl_modbusRTU(5,2,0);  //Address, channel, logic 0=off,1=on , Valve6
  relayControl_modbusRTU(5,3,0);  //Address, channel, logic 0=off,1=on , Valve7
  relayControl_modbusRTU(5,4,0);  //Address, channel, logic 0=off,1=on , Valve8

 relayControl_modbusRTU(6,16,0);  //Address, channel, logic 0=off,1=on , Valve8
