...
//if (WiFi.SSID()!="") wifiManager.setConfigPortalTimeout(60);
  ...
  if (!wifiManager.autoConnect("NodeMCU_LDR01", "password")) {
  ...
  digitalWrite(Relay1_btn1,HIGH);              // NODEMCU PIN D5
  digitalWrite(Relay2_btn2,HIGH);              // NODEMCU PIN D6
  digitalWrite(Relay3_ledblynk,HIGH);          // NODEMCU PIN D4
...
if(switchStatus1)
  {
    // auto
    if(ldr_percentage < LDRsensorLimit1)
    {
