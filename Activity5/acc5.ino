...
#define Widget_Btn_SW5 V10        //ปุ่ม เปิด-ปิด SW5
#define Widget_Btn_SW6 V12        //ปุ่ม เปิด-ปิด SW6
#define Widget_Btn_SW7 V14        //ปุ่ม เปิด-ปิด SW7
#define Widget_Btn_SW8 V16        //ปุ่ม เปิด-ปิด SW8
//==Define Blynk Virtual Pin for SW1-SW8==//
